    ...
    public static function getCategoriesBaseSelect(ResourceConnection $resource, CategoryMetaData $categoryMetaData): Select
    {
        ...
        return $resource->getConnection()
            ...
            ->from(
                ...
                "category_name_attr.$linkField = entity.entity_id AND category_name_attr.attribute_id = name_attr.attribute_id",
                ...
                "category_url_key_attr.$linkField = entity.entity_id AND category_url_key_attr.attribute_id = url_key_attr.attribute_id",
