...
class MultistoreProductAddAndDeleteTest extends BaseDirectDbEntityUpdateTest {
    ...
    public function shouldPublishProductsFromWebsite() {
        ...
        $this->setConfigurationValue($this->PRODUCT_ATTRIBUTES_PATH,'style_bags,status,visibility,small_image,thumbnail,meta_title,meta_description,price_type,special_price,special_from_date,special_to_date,tax_class_id');
