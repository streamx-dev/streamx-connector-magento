...
abstract class BaseMultistoreProductVariantIngestionTest extends BaseDirectDbEntityUpdateTest {
    ...
    protected function setUp(): void {
        ...
        $streamxClient->publish($publishProductsPayload, ProductProcessor::INDEXER_ID, $store1);
        $streamxClient->publish($publishProductsPayload, ProductProcessor::INDEXER_ID, $store2);
